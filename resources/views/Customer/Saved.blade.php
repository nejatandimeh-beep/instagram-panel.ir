...
@section('Content')
    ...
    <h5 class="text-right g-pa-15">
        ذخیره شده ها<i class="fa fa-bookmark g-font-size-22 g-ml-5 g-line-height-0_7"></i>
    </h5>
    <!--رویدادها-->
    <ul style="overflow-x: scroll" class="container list-inline hideScrollBar-x hideScrollBar g-flex-middle-item--bottom p-0 mx-auto {{isset($events[0]->ID) ? 'g-brd-bottom g-pb-20':'g-pb-15'}} g-brd-gray-light-v5">
        <span class="d-none">{{$temp=0}}</span>
        @foreach($events as $key => $row)
            @if($temp !== $row->sellerMajorID)
                <li style="{{$key==0 ? 'margin: 0 11px 0 0':'margin: 0 11px'}}" class="list-inline-item align-middle g-rounded-50x g-pa-5">
    ...
    <hr class="{{isset($posts[0])?'':'d-none'}} {{isset($events[0])?'':'d-none'}} g-brd-gray-light-v4 g-my-5">

    <!--پیش نمایش پست ها-->
    <div style="min-height: 100vh" class="container g-px-10--lg g-px-0">
                                    ...
                                    <div class="col-12 col-lg-3 mx-auto p-0 postID-{{$rec->postID}}"
                                        ...
                                        <div style="direction: rtl" class="g-pa-5 text-right">
                                            <div class="col-12 p-0 text-right d-flex justify-content-between">
                                                <a href="{{route('cSmPanel',$rec->sellerMajorID)}}"
                                ...
                                <div class="swiper-slide pauseTimer">
                                    <div style="position: relative">
                                        ...
                                        <div
                                            ...
                                            <a href="{{route('cSmPanel',$row->sellerMajorID)}}"
