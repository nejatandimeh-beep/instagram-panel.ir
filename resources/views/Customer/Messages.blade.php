            ...
            @foreach($msg as $key => $row)
                <li id="msg-{{$row->msgID}}"
                    ...
                    <div class="d-flex p-0 col-12">
                        <a href="{{route('cSmDetail',$row->SellerMajorID)}}" class="w-100 nav-link g-px-0 g-pb-5 g-pt-0">
                            <div class="p-0">
                                <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column g-pt-10">
                                            <div class="d-flex">
                                                ...
                                                <span style="direction: rtl"
                                                 ...
                                                 <span style="direction: rtl; color: red !important;"
                                                       class="{{$row->Status == 2? '' : 'd-none'}} align-self-center g-font-size-10 text-nowrap">پیغام جدید</span>
                                        </div>
                                </div>
                            </div>
                        </a>
